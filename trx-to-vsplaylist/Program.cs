...
public sealed class Program
{
    ...
    public static RootCommand GetRootCommand()
    {
        ...
        convertCommand.SetAction(parseResult =>
        {
            ...
            return ConvertCommand(trxFile, output, outcomes, skipEmpty);
        });
    ...
    private static Task<int> ConvertCommand(string trxFile, string? output, string[] outcomes, bool skipEmpty)
    {
